# Generated by Django 5.2 on 2025-05-01 10:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('admin', 'admin'), ('client', 'client')], max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event', to='book.event')),
            ],
        ),
    ]
